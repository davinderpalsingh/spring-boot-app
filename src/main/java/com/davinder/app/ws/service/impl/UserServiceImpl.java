...
public class UserServiceImpl implements UserService {
	...
	public UserDto createUser(UserDto user) {
		/*
		 * findByEmail() is a custom method defined in UserRepository.
		 * Before persisting the new user details in database, we want to ensure that
		 * there is no record already in the Users table with the same email id received
		 * in Request body of the POST api call. 
		 */
		...
		/*
		 * We are encrypting the password supplied in POST call by using Spring Security Framework support.
		 */
